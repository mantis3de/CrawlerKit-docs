# CrawlerKit Documentation (MkDocs Material)

This folder contains the documentation site for **CrawlerKit**, built with [MkDocs](https://www.mkdocs.org/) and the [Material](https://squidfunk.github.io/mkdocs-material/) theme.
...
3. Push to `main`. Every change under `Docs/**` rebuilds and publishes the site to
   `https://mantis3de.github.io/CrawlerKit/`.
