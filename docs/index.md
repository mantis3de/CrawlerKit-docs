...
Start with [Installation](getting-started/installation.md), then follow the [5-minute Quick Start](getting-started/quick-start.md) to ship your first playable room. Have a question before buying or while evaluating? Check the [FAQ](faq.md).
